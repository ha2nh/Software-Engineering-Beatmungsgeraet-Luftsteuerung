...
| :------: | :----------------: | :-------------------: | :------------: | :--------------------------: | 
|    M4    | Luftdruck-Alarm bei Ueberdruck | Sollwert = 18, aktueller Wert = 25 | Alarm1() | Rueckgabe = true| 
|    M5    | Auswahl der Benutzungsdauer | Dauerverwaltung esxistiert | Auswahlbenutzungsdauer(180) | Enum = "Min180" wird umgesetzt | 
|    M6    | Atemfrequenz anzeigen | Atemfrequenz = 12 | AnzeigenAtemfrequenz() | Ausgabe = 12 |
